...
---
>**免责声明**：本仓库为自用分享，可能存在诸多不足和错误，无法保证其准确性。如果您选择使用这些资源，请自行承担由此产生的风险和责任。谢谢您的理解和支持！
---
## 目录
...
- **韵调统一**：传统双拼往往不区分声调，导致编码信息利用率低下，离散弱，重码多；带调的输入法码长又太长。而自然龙将**韵母带上声调**并统一在**一个**键上，高效利用编码空间，单字能力和词组能力均大幅提高。
...
> 本仓库基于 Rime 平台。<br>
> 2024 年 4 月 25 日 增加了整句模式，和普通双拼打法一样，不再赘述。Thanks to [冰雪拼音](https://github.com/hanzi-chai/rime-snow-pinyin)
